...
In this chapter, we will introduce an alternative to maximum likelihood estimation of statistical models: Bayesian estimation. This concerns revising beliefs in light of observed data.
