...
By contrast, **exploratory factor analysis** (EFA) concerns a **reflective model**, where the latent variables "cause" the observed variables. A EFA model can be written as:
$$\begin{aligned}
Y_{1,i} &= \lambda_{1,1} \times \eta_{1,i} + \lambda_{1,2} \times \eta_{2,i} + \ldots + \lambda_{1,P} \times \eta_{P,i} + \epsilon_{1,i} && \epsilon_{1,i} \sim \mathbf{Normal}(0, \sigma_{\epsilon_1}) \\
Y_{2,i} &= \lambda_{2,1} \times \eta_{1,i} + \lambda_{2,2} \times \eta_{2,i} + \ldots + \lambda_{2,P} \times \eta_{P,i} + \epsilon_{2,i} && \epsilon_{2,i} \sim \mathbf{Normal}(0, \sigma_{\epsilon_2}) \\
\vdots \\
Y_{P,i} &= \lambda_{P,1} \times \eta_{1,i} + \lambda_{P,2} \times \eta_{2,i} + \ldots + \lambda_{P,P} \times  \eta_{P,i} + \epsilon_{P,i} && \epsilon_{P,i} \sim \mathbf{Normal}(0, \sigma_{\epsilon_P}) \\
