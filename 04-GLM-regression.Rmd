...
```{r simple-regression-explanation-plot,fig.cap="The simple regression model. __A__: The intercept is the mean of $Y$ when $X=0$ and is the point at which the regression line crosses the y-axis. The slope determines the steepness of the regression line and represents the increase (or decrease) in the mean of $Y$ for every 1-unit increase in the predictor $X$. __B__: the error terms or residuals are the vertical distances of each observed Y-value from the regression line. __C__: The errors in a regression model are assumed to follow a Normal distribution around the regression line.",fig.show="hold",fig.width=6,fig.height=6,out.width="100%"}
