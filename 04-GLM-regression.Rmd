...
```{r scatterplot-trump-votes-hate-groups-with-regression-model-comparison, fig.cap="Estimated regression lines for MODEL G (left) and MODEL R (right) with $\\beta_1 = 0$ and the errors.", fig.width=8, fig.height=4, out.width="100%", fig.show="hold"}
library(ggplot2)
library(dplyr)
