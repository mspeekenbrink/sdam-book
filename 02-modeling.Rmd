...
knitr::kable(tab, caption = "Relative frequency of heads for 1 to 15 flips. The cumulative frequency is the number of heads thus far, and the relative frequency the cumulative frequency divided by the number of flips.")
```
...
$H_0: \theta = .5$. In fact, the probability of obtaining a likelihood ratio of `r dbinom(2,14,.5)/dbinom(2,2,12/14)` or smaller if $H_0$ is true, the p-value, is `r pvalue(2*pbinom(2,14,.5))`. 
