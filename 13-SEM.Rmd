...
Table \@ref(tab:complex-path-legacy-motive-mi) shows the modification indices for fixed-to-zero parameters in this model, ordered by magnitude and ignoring parameters for which the modification index is smaller than 2. 


```{r complex-path-legacy-motive-mi}
...
fmod_complex_mi |>
  ...
  knitr::kable(align=c("l","r","r"), caption = "Modification indices and expected change in parameter values for fixed-to-zero parameters.", col.names=c("Parameter","Modification index", "Expected change"), escape = FALSE, row.names = FALSE, digits=3)
```
