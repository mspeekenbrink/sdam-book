...
Intuitively, you can think of a link function and its inverse as follows. Suppose you have ten British pounds and need to convert this into US dollars. The conversion rate (at the time of writing this) is £1 = \$1.25. So if $g$ is meant to convert pounds ($y$) to dollars ($x$), we would have 
$$g(y) = 1.25 \times x$$
