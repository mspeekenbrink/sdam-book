...
* Know the different types of data and their measurement scales
...
![Paul the octopus predicts Spain to win the final of the 2010 FIFA World
#|   Cup. Source: [The Guardian](https://www.theguardian.com/football/2010/jul/09/psychic-octopus-paul-picks-spain)](https://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2010/7/15/1279193684789/Paul-the-octopus-005.jpg){#fig-paul-the-octopus-image}

```{r}
#| label: paul-the-octopus-image
#| fig-cap: 'Paul the octopus predicts Spain to win the final of the 2010 FIFA World
#|   Cup. Source: [The Guardian](https://www.theguardian.com/football/2010/jul/09/psychic-octopus-paul-picks-spain)'
#| eval: false
...
Paul began his career during the UEFA Euro 2008 football tournament. In the lead-up to Germany's international football matches, Paul was presented with two clear plastic boxes, each containing food (a mussel or an oyster). Each container was marked with the flag of a team, one the flag of Germany, and the other the flag of Germany's opponent. The box which Paul opened first (and subsequently ate its contents) was deemed to be the predicted winner of the match. In this scheme, Paul predicted Germany to win all of their games, a correct prediction in 4 out of 6 cases (@tbl-uefa2008). He failed to predict their defeats by Croatia in the group stage, and by Spain in the championship's final.
...
Two years later, during the 2010 FIFA World Cup football tournament, Paul obtained celebrity status and his divinations were broadcast live on German TV. This time, Paul made correct predictions for all matches in which Germany played, as well as the final between Spain and the Netherlands (@tbl-fifa2010). Paul's record of 8/8 correct predictions in the 2010 World Cup is quite amazing. The common octopus (_Octopus vulgaris_) is indeed an intelligent species. But was Paul actually psychic? Could he truly foresee the future?
...
In addition to considering the type or measurement scale of the data, you will generally also need to consider the process that provided the data at hand. This process is called the __Data Generating Process__. 
...
```{r}
#| label: fig-london-tube-map
#| fig-cap: 'London tube map. Source: [TfL](https://tfl.gov.uk/maps/track/tube)'
#| eval: false
if(knitr::is_html_output()) {
