...
i.e. as the difference between the true mean $\mu_{j,k}$ at level $j$ of $A$ and level $k$ of factor $B$, and the predicted mean from treatment effects $\tau^{(A)}_j$ and $\tau^{(B)}_k$.
