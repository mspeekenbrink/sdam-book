...
So, sometimes "unusual" data points can have a large influence on model estimates, and sometimes not. There are several measures which aim to determine undue influence of observations on the model estimates, such as the _leverage_, Studentized residuals, Studentized deleted residuals, and Cook's distance. 
